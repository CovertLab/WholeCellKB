...
urlpatterns += patterns('public.views',	
	...
	url(r'^listParameters/(?P<species_wid>[a-zA-Z0-9_\-]+)/*$', 'list_parameters'),
	url(r'^listParameters/(?P<species_wid>[a-zA-Z0-9_\-]+)/(?P<type>[a-zA-Z0-9_\-]+)/*$', 'list_parameters'),
	...
	url(r'^viewParameterInSimulation/(?P<species_wid>[a-zA-Z0-9_\-]+)/(?P<wid>[a-zA-Z0-9_\-]+)/*$', 'viewParameterInSimulation'),
	url(r'^viewParametersInSimulation/(?P<species_wid>[a-zA-Z0-9_\-]+)/(?P<wid>[a-zA-Z0-9_\-]+)/*$', 'viewParametersInSimulation'),
